...
1. Automatically call our function when a parameter changes

1. Provide `magicgui` with a custom widget for a specific
argument

1. Use the `choices` option to create a dropdown
